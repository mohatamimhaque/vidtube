...
if (isset($_GET["v"])) {
    ...
    $query = mysqli_query(
        $con,
        "SELECT * FROM video WHERE unique_id = '$v' AND status = '0' "
    );
...
<div class="page_content">
	<div class="middle_bar">
        <div id="video_wrapper" style="display:nne">
            ...
            <div id="state" class="">
                ...
                <div id="video_overlay">
                    <img class="video_overlay_img" src="<?= base_url(
                        $th
                    ) ?>" alt="">
                                ...
                                <?php foreach (
                                    ...
                                    <?php } ?>
                                        ...
                                        foreach (
                                            mysqli_query(
                                                $con,
                                                "SELECT * FROM channel_list WHERE unique_id = '$owner'"
                                            )
                                            as $channel
                                        );
                                        ?>
        ...
        <div class="abt-mk"  style="display:noe">
            ...
            <div class="vcp_inf cr">
                <div class="vc_hd">
                    <img src="<?= base_url(
                        "upload/image/channel/profile_photo/" .
        ...
        <div class="comment_section" id="comment_section">
            ...
            <div class="dropdown">
                <button class="sort-btn" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                    <span class="ski"><svg aria-hidden="true" class="svg-icon mdi-outlined mdi-sort" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 -960 960 960"><path d="M120-240v-60h240v60H120Zm0-210v-60h480v60H120Zm0-210v-60h720v60H120Z"></path></svg></span>
                    <span>Sort by</span>
                </button>
            ...
            <div class="comment-box">
                <div class="d-flex comment">
                    <?php if (isset($_SESSION["loggedOren"])): ?>
                        <h1 class="<?= $user["first_name"][0] ?>"><?= $user[
    "first_name"
][0] ?></h1>
                    <?php else: ?>
                        <h1 class="M">M</h1>
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="hstack justify-content-end gap-1">
                            ...
                            <button class="btn btn-sm btn-primary rounded-pill" id="add_comment">Comment</button>
                        </div>
                    </div>
                </div>
    ...
    <div class="sidebar">
       <div class='list'>
        <?php
        $query = mysqli_query($con, "SELECT * FROM video LIMIT 12");
        if (mysqli_num_rows($query)) {
            foreach ($query as $vvv) {
                ...
                if (mysqli_num_rows($owner) > 0) {
                    foreach ($owner as $o); ?>
                    <a href="<?= $url . "video?v=" . $vvv["unique_id"] ?>">
                        <div class="vid_thumb">
                            <img src="<?= $th ?>" alt="">
                        ...
                        <div class="vid_info">
                            ...
                            <p class='vt'><?= numberFormat(
                                $vvv["views"]
                            ) ?> views . <small class="posted_dt"><?= dateTime(
     $vvv["created_at"]
 ) ?></small></p>
                        </div>
        ...
        <div class="pop-up videopage">
         <div class="pop-up__title">Save video to..
      ...
      <script src='<?= base_url(
          "assets/js/bootstrap-5.3.bundle.min.js"
      ) ?>'></script>
                ...
                function comment_show(){
                    ...
                    $.ajax({
                            ...
                            success:function(data){
                                ...
                                $('.total_comment').text(window.total_comment);
...
<script src="<?= base_url("assets/js/video-control.js") ?>"></script>
