									...
									<div id="video_wrapper">
										...
										<div id="video_player" class="paused">
											...
											<div id="video_overlay">
												<img class="video_overlay_img" src="<?= base_url('studio/assets/thumbnail/thumbnail.jpg') ?>" alt="">
											...
											<video id="main_video" preload="metadata"> 
												<source src="#" size="720" type="video/mp4">
											</video>
...
?>
<script src="<?= base_url('studio/assets/js/video-control.js') ?>"></script>
<script src="<?= base_url('studio/js/page_upload.js') ?>"></script>
<script>
	function upload(data){
		$.ajax({
			url:"<?= base_url('studio/ajax/uploadpage') ?>",
			method:"POST",
			data:data,
			contentType:false,
			processData:false,
