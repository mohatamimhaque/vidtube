...
if (preg_match('/mobile|android|touch|tablet/', $userAgent)) {
  function base_url($slug){
    echo 'http://192.168.1.101/vidtube/'.$slug;
  }
  $url = 'http://192.168.1.101/vidtube/';
  $ur = 'http://192.168.1.101/vidtube';
  
  
} else {
  function base_url($slug){
    echo 'http://localhost/vidtube/'.$slug;
  }
  $url = 'http://localhost/vidtube/';
  $ur = 'http://localhost/vidtube';
}
