    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= base_url("studio") ?>">
                        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Dashboards</span>
                    </a>
                   
                </li> <!-- end Dashboard Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?=  base_url('studio/home/'.$id.'/content') ?>">
                        <i class="las la-file-video "></i> <span data-key="t-video">Content</span>
                    </a>
                </li>
