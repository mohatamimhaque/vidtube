...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/fontello-codes.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/thumbs-embedded.css') ?>">
