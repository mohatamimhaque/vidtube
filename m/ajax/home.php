    ...
    if ($start <= $total_data) {
        ...
        ?>
             ...
             <input type="text" class="vid_id" value="<?= $row["unique_id"] ?>" style="display:none">
               ...
               <a class="video_player" href="<?= $url ."m/video?v=" .$row["unique_id"] ?>">
                  <video src='<?= $url ."studio/uploads/" .$row["unique_id"] ."/video/" .$row["video"] ?>'></video>
                  <div style = 'display:nne' class="video_overlay">
                     <img calss='' src="<?= base_url($th) ?>" alt="">
                  </div>
                  <span class='duration'><?= timeFormat($row["duration"]) ?></span>
                  <div class="progress_area" style="display:bock">
               ...
               <div class="info">
                  ...
                  <div class="center">
                     ...
                     <div class="information">
                        <span>@<?= $o["name"] ?></span>
                        <hr>
                        <span class="views"> <?= numberFormat(
                                $row["views"]
                            ) ?> views</span>
                        <hr>
                        <span class="time"><?= dateTime(
                        $row["created_at"]
                    ) ?></span>
                     </div>
                  </div>
